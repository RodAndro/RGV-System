...
<head>
    ...
    <style>
        :root { --mantis: #74c365; --mantis-dark: #468a3f; }
        ...
        .dark .sidebar-link-mantis:hover { background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%); color: #74c365; }
        .sidebar-link-active-mantis { padding: 12px 16px; background: linear-gradient(135deg, #74c365 0%, #5dad4f 100%); color: white; border-radius: 12px; font-weight: 600; box-shadow: 0 4px 15px rgba(116,195,101,0.3); }
        ...
        .badge-mantis-success { padding: 4px 12px; border-radius: 20px; font-size: 12px; font-weight: 600; background: linear-gradient(135deg, #f0f9ef 0%, #e0f3df 100%); color: #74c365; }
        ...
        .btn-mantis { display: inline-flex; align-items: center; padding: 10px 20px; background: linear-gradient(135deg, #74c365 0%, #5dad4f 100%); color: white; border-radius: 10px; font-weight: 600; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(116,195,101,0.3); border: none; cursor: pointer; }
                ...
                <div class="flex justify-between items-center px-4 md:px-8 py-4">
                    ...
                    <div class="flex items-center space-x-2 md:space-x-4 flex-shrink-0">
                        ...
                        <a href="{{ route('profile.edit') }}" class="flex items-center hover:opacity-80 transition-opacity flex-shrink-0" title="Edit Profile">
                            <div class="w-9 h-9 md:w-10 md:h-10 bg-gradient-to-br from-[#74c365] to-[#5dad4f] rounded-xl flex items-center justify-center text-white font-bold shadow-lg shadow-[#74c365]/30">
                                {{ auth()->user()->name[0] }}
                            </div>
