    ...
    <div class="card-mantis p-6 mb-8">
        <form action="{{ route('employee.inventories.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <select name="category" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#74c365] focus:border-[#74c365] transition-all bg-gray-50">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div class="card-mantis p-6">
            <div class="flex items-center justify-between">
                ...
                <div class="bg-[#f0f9ef] w-12 h-12 rounded-xl flex items-center justify-center"><i class="fas fa-boxes text-[#74c365] text-xl"></i></div>
            </div>
        </div>
        <div class="card-mantis p-6">
            <div class="flex items-center justify-between">
        ...
        <div class="card-mantis p-6">
            <div class="flex items-center justify-between">
                <div><p class="text-gray-500 text-sm">Available</p><p class="text-3xl font-bold text-[#74c365]">{{ $stats['available'] }}</p></div>
                <div class="bg-[#f0f9ef] w-12 h-12 rounded-xl flex items-center justify-center"><i class="fas fa-check-circle text-[#74c365] text-xl"></i></div>
            </div>
        </div>
        <div class="card-mantis p-6">
            <div class="flex items-center justify-between">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="card-mantis overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <div class="flex items-center space-x-2 mb-1">
                        <span class="text-xs font-mono text-[#74c365] font-semibold">{{ $inventory->item_code }}</span>
                    ...
                    <div class="flex items-center justify-between">
                        <a href="{{ route('employee.inventories.show', $inventory) }}" class="text-[#74c365] hover:text-[#5dad4f] font-semibold text-sm">
        ...
        @empty
            <div class="col-span-full text-center py-12 text-gray-500">
                ...
                <a href="{{ route('employee.inventories.index') }}" class="text-[#74c365] hover:text-[#5dad4f] font-semibold mt-4 inline-block">Clear filters</a>
            </div>
        @endforelse
    </div>
