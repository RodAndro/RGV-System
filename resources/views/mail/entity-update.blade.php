...
<head>
    ...
    <style>
        ...
        .header { background: linear-gradient(135deg, #74c365, #468a3f); color: white; padding: 24px; text-align: center; }
        .header h1 { margin: 0; font-size: 20px; }
        .body { padding: 24px; }
        .body p { color: #374151; line-height: 1.6; margin: 8px 0; }
        .info-box { background: #f9fafb; border-left: 4px solid #74c365; padding: 16px; margin: 16px 0; border-radius: 4px; }
        .info-box strong { color: #374151; }
        .btn { display: inline-block; background: #74c365; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 600; margin-top: 16px; }
