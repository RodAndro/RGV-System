...
@section('title', 'Add Inventory Item - Admin Dashboard')
...
<div class="p-4 md:p-8">
    ...
    <div class="card-mantis p-6 md:p-8">
        ...
        <form action="{{ route('admin.inventories.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="border-2 border-dashed border-gray-200 dark:border-gray-600 rounded-xl p-8 text-center hover:border-[#2563eb] transition bg-gray-50 dark:bg-gray-800 mb-6">
