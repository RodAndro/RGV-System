...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    @guest
                        <a href="{{ route('booking.form') }}" class="bg-gradient-to-r from-[#2563eb] to-[#1d4ed8] text-white px-4 py-2 rounded-xl hover:from-[#1d4ed8] hover:to-[#1e40af] transition-all shadow-lg shadow-[#2563eb]/30">
    ...
    <!-- Hero Section -->
    <section class="bg-gradient-to-r from-[#2563eb] to-[#1d4ed8] text-white py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col lg:flex-row items-center">
                <div class="lg:w-1/2 mb-10 lg:mb-0">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="{{ route('booking.form') }}" class="bg-white text-[#2563eb] px-8 py-3 rounded-xl font-semibold hover:bg-gray-50 transition-all text-center shadow-lg">
                            <i class="fas fa-calendar-check mr-2"></i>Book Now
                        </a>
                        <a href="#services" class="border-2 border-white text-white px-8 py-3 rounded-xl font-semibold hover:bg-white hover:text-[#2563eb] transition-all text-center">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition border border-gray-100">
                    <div class="bg-[#eff6ff] w-16 h-16 rounded-xl flex items-center justify-center mb-4">
                        <i class="fas fa-wrench text-[#2563eb] text-2xl"></i>
                    </div>
                ...
                <div class="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition border border-gray-100">
                    <div class="bg-[#eff6ff] w-16 h-16 rounded-xl flex items-center justify-center mb-4">
                        <i class="fas fa-tools text-[#2563eb] text-2xl"></i>
                    </div>
                ...
                <div class="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition border border-gray-100">
                    <div class="bg-[#eff6ff] w-16 h-16 rounded-xl flex items-center justify-center mb-4">
                        <i class="fas fa-cog text-[#2563eb] text-2xl"></i>
                    </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white rounded-xl p-6 shadow border border-gray-100">
                    <div class="flex items-center mb-4">
                        <div class="w-12 h-12 bg-gradient-to-br from-[#2563eb] to-[#1d4ed8] rounded-xl flex items-center justify-center text-white font-bold shadow-lg shadow-[#2563eb]/30">JD</div>
                        <div class="ml-4">
                ...
                <div class="bg-white rounded-xl p-6 shadow border border-gray-100">
                    <div class="flex items-center mb-4">
                        <div class="w-12 h-12 bg-gradient-to-br from-[#2563eb] to-[#1d4ed8] rounded-xl flex items-center justify-center text-white font-bold shadow-lg shadow-[#2563eb]/30">JS</div>
                        <div class="ml-4">
                ...
                <div class="bg-white rounded-xl p-6 shadow border border-gray-100">
                    <div class="flex items-center mb-4">
                        <div class="w-12 h-12 bg-gradient-to-br from-[#2563eb] to-[#1d4ed8] rounded-xl flex items-center justify-center text-white font-bold shadow-lg shadow-[#2563eb]/30">MJ</div>
                        <div class="ml-4">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="text-center">
                    <div class="bg-[#eff6ff] w-16 h-16 rounded-xl flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-map-marker-alt text-[#2563eb] text-2xl"></i>
                    </div>
                ...
                <div class="text-center">
                    <div class="bg-[#eff6ff] w-16 h-16 rounded-xl flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-phone text-[#2563eb] text-2xl"></i>
                    </div>
                ...
                <div class="text-center">
                    <div class="bg-[#eff6ff] w-16 h-16 rounded-xl flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-envelope text-[#2563eb] text-2xl"></i>
                    </div>
    ...
    <footer class="bg-gray-800 text-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-4 gap-8">
                <div>
                    <div class="flex items-center mb-4">
                        <div class="w-10 h-10 bg-gradient-to-br from-[#2563eb] to-[#1d4ed8] rounded-xl flex items-center justify-center mr-3">
                            <i class="fas fa-cogs text-white text-lg"></i>
                        </div>
