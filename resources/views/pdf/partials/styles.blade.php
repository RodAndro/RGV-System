<style>
    ...
    .pdf-header h1 { color: #1e40af; margin: 0; font-size: 16px; }
    ...
    .section-title { font-size: 14px; font-weight: bold; color: #1e40af; margin: 20px 0 10px; border-bottom: 1px solid #e5e7eb; padding-bottom: 5px; }
    ...
    .signature-section { margin-top: 40px; padding-top: 20px; border-top: 2px solid #2563eb; }
