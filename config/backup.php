...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('APP_NAME', 'RGV Multi-Tech Services'),
        ...
        'destination' => [
            ...
            'disks' => array_values(array_filter([
                'local',
                env('BACKUP_TO_S3', false) ? 's3' : null,
            ])),
        ],
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'admin@rgvtech.com'),

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'no-reply@rgvtech.com'),
                'name' => env('MAIL_FROM_NAME', 'RGV Multi-Tech Services'),
            ],
        ],
